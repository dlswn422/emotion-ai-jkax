      ...
      <div class="page-body">
        ...
        <div class="page-hero-bar">
          <div>
            ...
            <p class="page-sub">기업 {{ filteredCompanies.length }}개 · 매장 {{ filteredStores.length }}개</p>
          </div>
          <button class="btn btn-brand" @click="filteredStores.length && openAnalysis(filteredStores[0])">
