...
import { goGoogleBusinessConnect } from '../api/auth.js';
    ...
    <div class="landing-wrap">
      ...
      <section class="hero-section">
        ...
        <div class="hero-inner">
          ...
          <div class="hero-left">
            ...
            <h1 class="hero-h1">
              리뷰 데이터를<br />
              <em>실행 가능한<br />인사이트</em>로
            </h1>

            <p class="hero-desc">
              Google 리뷰 및 설문 데이터를 AI가 즉시 분석하여
              매장 운영에 바로 적용할 수 있는 전략과 액션 플랜을 제공합니다.
            </p>
          ...
          <div class="hero-right">
            ...
            <div class="hero-dashboard">
              <div class="dash-topbar">
                ...
                <span style="font-size:11px;color:var(--n-400);margin-left:8px;font-weight:500;">
                  CX Nexus · 예원 한식당
                </span>
              </div>
      ...
      <div class="stat-strip">
        <div class="stat-strip-inner">
          <div class="strip-item">
            <div class="strip-val">500+</div>
            <div class="strip-label">분석된 매장 수</div>
          </div>
          <div class="strip-item">
            <div class="strip-val">98%</div>
            <div class="strip-label">고객 만족도</div>
          </div>
          <div class="strip-item">
            <div class="strip-val">5분</div>
            <div class="strip-label">평균 분석 시간</div>
          </div>
          <div class="strip-item">
            <div class="strip-val">15+</div>
            <div class="strip-label">CX 분석 지표</div>
          </div>
        </div>
      </div>
      ...
      <section class="bento-section">
        <div class="section-header-wrap">
          ...
          <p class="section-p">
            복잡한 고객 데이터를 단 5분 만에 실행 가능한 전략으로 변환합니다.
          </p>
        </div>
        ...
        <div class="bento-grid" style="max-width:1320px;margin:0 auto;">
          <div class="bento-card span-2">
            ...
            <p class="bento-p">
              GPT 기반 AI가 수백 개의 리뷰를 실시간 분석하여 감성, 키워드, 만족 요인,
              개선점을 자동 도출합니다. 5분 내 전략 보고서 완성.
            </p>
            ...
            <div class="bento-visual">
              ...
              >
                ...
                <div class="bento-bar-track">
                  <div class="bento-bar-fill" :style="{ width: b.w }"></div>
                </div>
        ...
        <div class="pricing-grid">
          <div class="pricing-card">
            ...
            <ul class="pricing-features">
              <li
                v-for="f in ['매장 1개', '월 200개 리뷰 분석', '기본 CX 보고서', '월 1회 PDF 출력']"
                :key="f"
              >
                <div class="fi">
                  <svg width="7" height="7" fill="none" stroke="white" stroke-width="3" viewBox="0 0 24 24">
          ...
          <div class="pricing-card featured">
            ...
            <ul class="pricing-features">
              <li
                v-for="f in ['매장 5개', '무제한 리뷰 분석', 'AI 전략 인사이트', '무제한 PDF 출력', 'Action Plan 자동 생성']"
                :key="f"
              >
                <div class="fi">
                  <svg width="7" height="7" fill="none" stroke="white" stroke-width="3" viewBox="0 0 24 24">
          ...
          <div class="pricing-card">
            ...
            <ul class="pricing-features">
              <li
                v-for="f in ['무제한 매장', 'API 연동 지원', '전담 CX 컨설턴트', '커스텀 대시보드']"
                :key="f"
              >
                <div class="fi">
                  <svg width="7" height="7" fill="none" stroke="white" stroke-width="3" viewBox="0 0 24 24">
        ...
        <div class="footer-inner">
          <div class="footer-top">
            <div>
              ...
              <p class="footer-brand-desc">
                AI 기반 고객경험(CX) 분석 플랫폼. 리뷰 데이터를 실행 가능한 인사이트로 전환합니다.
              </p>
              ...
              <a href="mailto:contact@jkax.co.kr" class="footer-brand-email">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-1.9 2-2z" />
          ...
          <div class="footer-bottom">
            ...
            <div style="display:flex;gap:16px;">
              <a href="#">개인정보처리방침</a>
              <a href="#">이용약관</a>
              <a href="mailto:contact@jkax.co.kr" style="color:var(--accent-cyan);">
                contact@jkax.co.kr
              </a>
            </div>
          </div>
