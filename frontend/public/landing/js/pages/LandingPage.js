  ...
  template: `
      ...
      <div class="hero-inner">
        <div class="hero-left">
          ...
          <p class="hero-desc">
            Google 리뷰 및 설문 데이터를 AI가 즉시 분석하여 매장 운영에 바로
            적용할 수 있는 전략과 액션 플랜을 제공합니다.
          </p>
          ...
          <div class="hero-cta-row">
            ...
            <button class="btn btn-b2b btn-lg" @click="router.push('/B2B')" style="display: none;">
    ...
    <section class="bento-section">
      ...
      <div class="bento-grid" style="max-width:1320px;margin:0 auto">
        <div class="bento-card span-2">
          ...
          <p class="bento-p">
            GPT 기반 AI가 수백 개의 리뷰를 실시간 분석하여 감성, 키워드,
            만족 요인, 개선점을 자동 도출합니다. 5분 내 전략 보고서 완성.
          </p>
    ...
    <section class="pricing-section">
      ...
      <div class="pricing-grid">
        <div class="pricing-card">
          ...
          <button class="btn btn-ghost w-full" style="justify-content:center" @click="router.push('/stores')">
            시작하기
          </button>
        </div>
        ...
        <div class="pricing-card featured">
          ...
          <button class="btn btn-brand w-full" style="justify-content:center" @click="router.push('/stores')">
            시작하기
          </button>
        </div>
        ...
        <div class="pricing-card">
          ...
          <a class="btn btn-ghost w-full" href="mailto:contact@jkax.co.kr" style="justify-content:center">
            문의하기
          </a>
        </div>
      </div>
