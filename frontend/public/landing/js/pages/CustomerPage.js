...
export const CustomerPage = defineComponent({
  ...
  setup(props) {
    ...
    /**
     * KPI 증감 방향에 따라 스타일 클래스 반환
     * invert=true면 감소가 좋은 값(예: 이탈 위험)에 사용
     */
    ...
    /**
     * KPI 증감 방향에 따라 화살표 SVG path 반환
     * invert=true면 감소가 좋은 값에 사용
     */
            ...
            <div class="r-card" style="flex:1">
              ...
              <div class="r-card-body">
                <div class="ca-risk-bars">
                  <div class="ca-risk-row">
                    ...
                    <div class="ca-risk-track">
                      <div
                        class="ca-risk-fill"
                        :style="{width:(customers.riskDistribution.high?.pct || 0)+'%',background:'linear-gradient(90deg,#f43f5e,#fb7185)'}"
                      ></div>
                    </div>
                  ...
                  <div class="ca-risk-row">
                    ...
                    <div class="ca-risk-track">
                      <div
                        class="ca-risk-fill"
                        :style="{width:(customers.riskDistribution.medium?.pct || 0)+'%',background:'linear-gradient(90deg,#f59e0b,#fbbf24)'}"
                      ></div>
                    </div>
                  ...
                  <div class="ca-risk-row">
                    ...
                    <div class="ca-risk-track">
                      <div
                        class="ca-risk-fill"
                        :style="{width:(customers.riskDistribution.low?.pct || 0)+'%',background:'linear-gradient(90deg,#10b981,#34d399)'}"
                      ></div>
                    </div>
                ...
                <div class="ca-churn-insight">
                  ...
                  이번 달 이탈 위험 고객은
                  <strong>{{ customers.riskDistribution.high?.count || 0 }}명</strong>명이고,
                  평균 이탈 확률은
            ...
            <div class="ca-segment-grid">
              <div class="ca-seg-card" style="--seg-color:#6366f1;--seg-bg:#eef2ff">
                ...
                <div class="ca-seg-metrics">
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">평균 평점</span>
                    <span class="ca-seg-m-val" style="color:#6366f1">
                      {{ Number(customers.segments.loyal?.avg_rating || 0).toFixed(1) }}
                    </span>
                  </div>
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">평균 지출</span>
                    <span class="ca-seg-m-val" style="color:#6366f1">₩52K</span>
                  </div>
                </div>
              ...
              <div class="ca-seg-card" style="--seg-color:#10b981;--seg-bg:#ecfdf5">
                ...
                <div class="ca-seg-metrics">
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">평균 평점</span>
                    <span class="ca-seg-m-val" style="color:#10b981">
                      {{ Number(customers.segments.new?.avg_rating || 0).toFixed(1) }}
                    </span>
                  </div>
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">전환률</span>
                    <span class="ca-seg-m-val" style="color:#10b981">{{ customers.segments.new?.conversion_rate || 0 }}%</span>
                  </div>
                </div>
                <div class="ca-seg-bar-wrap">
              ...
              <div class="ca-seg-card" style="--seg-color:#f43f5e;--seg-bg:#fff1f2">
                <div class="ca-seg-header">
                  <div class="ca-seg-icon" style="background:#fff1f2">
                    <svg width="16" height="16" fill="none" stroke="#f43f5e" stroke-width="2" viewBox="0 0 24 24">
                      <path d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                  </div>
                ...
                <div class="ca-seg-metrics">
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">평균 평점</span>
                    <span class="ca-seg-m-val" style="color:#f43f5e">
                      {{ Number(customers.segments.at_risk?.avg_rating || 0).toFixed(1) }}
                    </span>
                  </div>
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">이탈 확률</span>
                    <span class="ca-seg-m-val" style="color:#f43f5e">{{ customers.segments.at_risk?.churn_probability || 0 }}%</span>
                  </div>
                </div>
                <div class="ca-seg-bar-wrap">
              ...
              <div class="ca-seg-card" style="--seg-color:#f59e0b;--seg-bg:#fffbeb">
                ...
                <div class="ca-seg-metrics">
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">평균 평점</span>
                    <span class="ca-seg-m-val" style="color:#f59e0b">
                      {{ Number(customers.segments.reactivation?.avg_rating || 0).toFixed(1) }}
                    </span>
                  </div>
                  <div class="ca-seg-metric">
                    <span class="ca-seg-m-label">재활성 가능</span>
                    <span class="ca-seg-m-val" style="color:#f59e0b">{{ customers.segments.reactivation?.reactivation_probability || 0 }}%</span>
                  </div>
                </div>
                <div class="ca-seg-bar-wrap">
              ...
              >
                ...
                <div class="ca-funnel-info">
                  ...
                  <div class="ca-funnel-right">
                    <span class="ca-funnel-count" :style="{color:step.color}">{{step.count.toLocaleString()}}</span>
              ...
              <table class="ca-cohort-table">
                ...
                <tbody>
                  <tr v-for="row in (customers.cohort.rows || [])" :key="row.cohort">
                    ...
                    <td
                      v-for="key in ['m1','m2','m3','m4','m5']"
                      :key="key"
                      class="ca-cohort-cell"
                    >
                      <div
                    ...
                    <tr class="ca-table-row" @click="toggleCustomer(cust.id)">
                      <td>
                        <div class="ca-cust-name-cell">
                          <div
                            class="ca-cust-avatar"
                            :style="{
                              background:cust.risk==='HIGH'?'#fff1f2':cust.risk==='MEDIUM'?'#fffbeb':'#ecfdf5',
                              color:cust.risk==='HIGH'?'#f43f5e':cust.risk==='MEDIUM'?'#f59e0b':'#10b981'
                            }"
                          >
                            {{cust.name.charAt(0)}}
                          </div>
                      ...
                      <td>
                        <div class="ca-churn-cell">
                          <div class="ca-churn-bar">
                            <div
                              class="ca-churn-fill"
                              :style="{width:cust.churnPct+'%',background:cust.churnPct>=70?'#f43f5e':cust.churnPct>=40?'#f59e0b':'#10b981'}"
                            ></div>
                          </div>
                          <span
                            :style="{
                              color:cust.churnPct>=70?'#f43f5e':cust.churnPct>=40?'#f59e0b':'#10b981',
                              fontWeight:'700',
                              fontSize:'12px'
                            }"
                          >
                      ...
                      <td>
                        <svg
                          :style="{transform:expandedCustomer===cust.id?'rotate(180deg)':'',transition:'transform .2s'}"
                          width="14"
                          height="14"
                          fill="none"
                          stroke="currentColor"
