  ...
  shinilpharm: {
    ...
    external: {
      ...
      issueSources: [
        {
          source: "뉴스",
          title: "제약사 생산 확대에 따른 용기 수요 증가 전망",
          impact: "high",
        },
      ...
      issueKeywords: [
        {
          ...
          signal_level: "high",
          hit_count: 14,
          opportunity: "가격 투명성 강조 세일즈 포인트",
        },
        {
          keyword: "납기",
          signal_level: "medium",
          hit_count: 7,
          opportunity: "공급 안정성 홍보",
        },
      ],
      monthlyScores: [
        { d: "12월", me: 61, avg: 58 },
    ...
    customerAnalysis: {
      ...
      recommendations: [
        {
          title: "CRM API 연결",
          desc: "Salesforce / HubSpot API를 연결해 고객 데이터를 자동 수집합니다",
        },
        {
          title: "CSV 업로드",
          desc: "고객 데이터를 CSV 형식으로 일괄 업로드합니다",
        },
      ],
    },
  },
  ...
  comp_1: {
      ...
      issueKeywords: [
        {
          ...
          signal_level: "high",
          hit_count: 21,
          opportunity: "AS 응대 개선 메시지 필요",
        },
        {
          keyword: "가격 정책",
          signal_level: "medium",
          hit_count: 11,
          opportunity: "프로모션 전략 수립",
        },
      ],
      monthlyScores: [
        { d: "12월", me: 73, avg: 70 },
    ...
    customerAnalysis: {
      ...
      cohort: {
        ...
        summary_text:
          "현대 인도네시아 고객 코호트는 1개월차 재방문율이 58~64% 수준으로 안정적입니다.",
      },
      list: [
        {
          id: 1,
  ...
  comp_2: {
    ...
    external: {
      ...
      issueSources: [
        {
          source: "뉴스",
          title: "동남아 시장 확장 파트너십 체결",
          impact: "medium",
        },
        {
          source: "커뮤니티",
          title: "리포트 기능 부족 피드백 증가",
          impact: "medium",
        },
      ],
    },
      ...
      issueKeywords: [
        {
          ...
          signal_level: "high",
          hit_count: 13,
          opportunity: "도입 단순화 메시지 필요",
        },
        {
          keyword: "보고서 기능 부족",
          signal_level: "medium",
          hit_count: 9,
          opportunity: "리포팅 강점 차별화",
        },
      ],
      monthlyScores: [
        { d: "12월", me: 62, avg: 61 },
...
export function detectAndCreateAlerts(report, companyName, compId) {
  const sources = [
    {
      src: report?.external?.topKeywords?.negative ?? [],
      tab: "external",
      tabLabel: "고객 동향",
    },
    {
      src: report?.ownReview?.negKeywords ?? [],
      tab: "ownreview",
      tabLabel: "리뷰 감정",
    },
  ];
