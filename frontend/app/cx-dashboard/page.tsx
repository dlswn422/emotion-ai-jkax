...
function CxDashboardInner() {
  ...
  return (
    <main className="min-h-screen bg-white">
      {/* ================= FIXED HEADER ================= */}
      <header className="fixed top-0 inset-x-0 z-40 bg-white border-b print-hidden">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-semibold rounded-lg"
          >
      ...
      {/* ================= ✅ AI LOADING OVERLAY (HEADER 살아있음) ================= */}
      {loading && !downloading && !navigatingBack && (
        <div className="fixed inset-x-0 top-14 bottom-0 z-30 bg-white/70 backdrop-blur
