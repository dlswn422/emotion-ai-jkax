...
목적
- 리뷰에서 반복 등장하는 핵심 키워드를
  긍정 / 부정으로 나누어 충분히 생성한다.
...
2. 각 배열은 반드시 최소 12개 이상 생성해야 한다.
   부족할 경우 의미가 유사한 하위 키워드까지 확장해서 채워라.

==============================
감성 기준
==============================

3. 감성은 단어가 아니라 "등장 문맥 기준"이다.

positive_keywords:
- 칭찬 / 만족 / 지지 맥락에서 등장한 키워드

negative_keywords:
- 불만 / 비판 / 문제 제기 맥락에서 등장한 키워드
...
5. 반드시 명사 또는 명사구 (2~10자)

예:
- 대통령, 이재명, 부동산, 전세, 월세, 아파트
...
6. 모든 주요 주제는 반드시 3개 이상 파생 키워드를 생성하라.
